 ...
 * BlogPage Component
 * 
 * This component represents the **Blog** page of the Great.bg website.
 * It displays a list of example blog posts in a responsive grid layout.
 *
 * @component
 * @example
 * // Usage:
 ...
 * }
 * 
 * @returns {JSX.Element} A styled blog page with sample posts.
 */
function BlogPage() {
    return (
